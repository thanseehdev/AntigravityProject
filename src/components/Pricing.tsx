...
export default function Pricing() {
  return (
    <section className="w-full py-24 px-6 md:px-12 lg:px-24 flex flex-col items-center lg:items-end relative z-20">
      <FadeIn>
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-16 text-center max-w-lg w-full border border-white shadow-2xl shadow-zinc-200/40 relative overflow-hidden group">
